...
void freeListProc(ListProc p);
void freeProcVar(ProcVar p);
void freeName(Name p);
void freeListName(ListName p);
...
void freeListKeyValuePair(ListKeyValuePair p);
