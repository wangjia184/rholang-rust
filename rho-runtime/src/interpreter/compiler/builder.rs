...
pub fn build_ast(source: &str) -> std::result::Result<Par, CompliationError> {
    ...
    unsafe {
        ...
        // here use fmemopen() to stream C-string as FILE* to avoid memory leaks
    ...
    let result = normalize::from_root(proc);
